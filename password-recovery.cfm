...
<head>
    <cfquery name="getMeta" datasource="Application.metadata" dbtype="query">
        ...
        WHERE template = 'global' OR template = 'password-recovery'
    </cfquery>
    ...
    <title>flyvalle: Password Recovery</title>
            ...
            <div class="row">
                <div class="container mt-1">
                    <div class="col-md-6 col-sm-offset-3">
                        <h2 class="section-title no-margin-top">Recover your account's password</h2>
                        <div class="panel panel-primary animated fadeInRight animation-delay-2">
                            ...
                            <div class="panel-body">
                                <form id="getPasswordForm" role="form" name="subscriptionForm">
                                    <div class="form-group">
                                        <label for="registrationEmail">Email<sup>*</sup></label>
                                        <input type="email" class="form-control" id="registration-email" name="email" data-path="./">
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="checkbox checkbox-inline">
                                                <input type="checkbox" id="changePassAgree" name="terms" value="1">
                                                <label for="changePassAgree"><small>Email me the info to change my password</small></label>
                                            </div>
                                             --->
                                        </div>
                                        <input type="hidden" name="role" value="1">
                                        <div class="col-md-4">
                                            <button id="changePassBtn" type="submit" class="btn btn-ar btn-primary pull-right" data-path="./">Change Password</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
