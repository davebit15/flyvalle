<nav class="navbar navbar-default navbar-header-full navbar-inverse yamm navbar-static-top" role="navigation" id="header">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a id="ar-brand" class="navbar-brand hidden-lg hidden-md hidden-sm" href="index.cfm"><span>fly</span>valle!</a>
        </div> <!-- navbar-header -->
            ...
            <ul class="nav navbar-nav">
                <cfoutput>
                    <cfif SESSION.loginData.logged EQ 0>
                        <li class="dropdown visible-xs">
                            <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"><var class="small">You're not logged in</var></a>
                    ...
                    <cfelse>
                        <li class="dropdown visible-xs">
                            <a href="login.cfm"><var class="small">You're logged in as</var> <strong>#SESSION.loginData.username#</strong></a>
                        </li>
                    </cfif>
                </cfoutput>
                <li class="yamm-fw">
                    <a href="index1.cfm">Home</a>
                </li>
                ...
                <li class="dropdown">
                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">Contact</a>
                     <ul class="dropdown-menu dropdown-menu-left animated-2x animated fadeIn">
                        <li><a href="hotel-reservations">Book a hotel in Valle</a></li>
                        <li><a href="tandem-reservations.cfm">Book a tandem flight</a></li>
                        <li><a href="about-learning.cfm">Learning to fly</a></li>
                        <li class="divider"></li>
                        <li><a href="contact.cfm"><i class="fa fa-envelope"> </i> Send us an email</a></li>
                    </ul>
                </li>
             </ul>
        </div><!-- navbar-collapse -->
