    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="">
                    <a href="dashboard.cfm" class="">Dashboard</a>
                </li>
                ...
                <li class="dropdown">
                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">Content</a>
                     <ul class="dropdown-menu dropdown-menu-left animated-2x animated fadeIn">
                        <li class="dropdown-submenu">
                            <a href="javascript:void(0);" class="has_children">About us</a>
                        ...
                        <li class="">
                            <a href="articles.cfm" class="">Articles</a>
                        </li>
                        <li class="dropdown-submenu">
                ...
                <li class="dropdown">
                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">Main Site</a>
                     <ul class="dropdown-menu dropdown-menu-left animated-2x animated fadeIn">
                        <cfoutput>
                            <li><a href="#request.webRoot#index.cfm">Home</a></li>
                            <li><a href="#request.webRoot#articles.cfm">Articles</a></li>
